...
CREATE TABLE IF NOT EXISTS assignments (
    ...
    owner_discord_user_id VARCHAR(120),
    created_at TIMESTAMPTZ NOT NULL DEFAULT NOW(),
...
ALTER TABLE assignments ADD COLUMN IF NOT EXISTS is_personal BOOLEAN NOT NULL DEFAULT FALSE;
ALTER TABLE assignments ADD COLUMN IF NOT EXISTS owner_discord_user_id VARCHAR(120);
